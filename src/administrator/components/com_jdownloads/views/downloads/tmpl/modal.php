...
?>
<form action="<?php echo JRoute::_('index.php?option=com_jdownloads&view=downloads&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
	<div class="left">
        <b><?php echo JText::_('COM_JDOWNLOADS_BACKEND_FILESLIST_ONLY_WITH_FILES'); ?></b>
        <p> </p>
    </div>
