...
/**
    ...
    */
    ...
    public static function contentJDispatchEvents($html)
    {
        ...
        $results = $dispatcher->trigger('onContentPrepare', array('com_jdownloads.category', &$article, &$params, 0));
        $results = $dispatcher->trigger('onContentAfterTitle', array('com_jdownloads.category', &$article, &$params, 0));
        $results = $dispatcher->trigger('onContentBeforeDisplay', array('com_jdownloads.category', &$article, &$params, 0));
        $results = $dispatcher->trigger('onContentAfterDisplay', array('com_jdownloads.category', &$article, &$params, 0));
